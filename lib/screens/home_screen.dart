...
import 'package:kartdaddy/screens/trending_products_screen.dart';
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Image.network(img, height: 150, errorBuilder:
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      UnderlineContainer(
                          child: Heading(
                        text: AppLocalizations.of(context)!.popular_products,
                      )),
                      TextButton(
                          onPressed: () {
                        ...
                        (index) => InkWell(
                          onTap: () {
                            Get.to(() => ProductScreen(
                                  productData: DemoData.demoProductData[0],
                                ));
                          },
                          child: Container(
                            margin: const EdgeInsets.all(8),
                  ...
                  Align(
                    ...
                    child: UnderlineContainer(
                      child: Heading(
                        text: AppLocalizations.of(context)!.known_products,
                      ),
                    ),
                  ),
                  const Gap(40),
